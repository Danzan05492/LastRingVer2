<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('dashboard') }}" class="nav-link">Главная</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('freedoms.index') }}" class="nav-link">Список дел</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="{{ route('condemneds.index') }}" class="nav-link">Список осужденных</a>
      </li>
